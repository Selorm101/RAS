                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                    <section className="px-6 py-20 bg-[#080808]">
                                                                                                                                                                                                                                                                                            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                                                                                                                                                                                                                                                                                      {["AI Scoring", "Apex Wallet", "Identity", "Logistics"].map((title, i) => (
                                                                                                                                                                                                                                                                                                                  <div key={i} className="bg-[#0D0D0D] border border-white/5 p-8 rounded-2xl">
                                                                                                                                                                                                                                                                                                                                <Zap size={32} className="text-cyan-500 mb-6" />
                                                                                                                                                                                                                                                                                                                                              <h4 className="text-lg font-black mb-3 tracking-tight">{title}</h4>
                                                                                                                                                                                                                                                                                                                                                            <p className="text-sm text-gray-500 normal-case">Automated systems for the ultimate competitive experience.</p>
                                                                                                                                                                                                                                                                                                                                                                        </div>
                                                                                                                                                                                                                                                                                                                                                                                  ))}
                                                                                                                                                                                                                                                                                                                                                                                          </div>
                                                                                                                                                                                                                                                                                                                                                                                                </section>
